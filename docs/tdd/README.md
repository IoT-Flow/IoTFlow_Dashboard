# TDD Documentation - IoTFlow Dashboard
...
- **[TDD_APPROACH.md](TDD_APPROACH.md)** - General TDD approach for the dashboard
...
**Main TDD documentation:** `iotflow-backend/docs/tdd/`
