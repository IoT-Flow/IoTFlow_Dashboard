    ...
    return (
      <Card>
        <CardContent>
          ...
          <Alert severity="info">
            No controllable devices found. Register LED lights, pumps, locks, or other controllable devices to see quick controls here.
          </Alert>
        </CardContent>
      </Card>
    );
                ...
                >
                  <CardContent sx={{ p: 2 }}>
                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center">
                      <Box>
                        {getQuickActions(device.type).slice(0, 2).map((action, index) => (
